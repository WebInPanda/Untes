        ...
        <div className="flex-1 overflow-y-auto pr-2 space-y-6">
          ...
          <div className="space-y-4 p-4 bg-muted/50 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <Button data-testid="button-add-debt" variant="destructive" onClick={() => addTransaction(true)} className="flex-1">Borç Ekle (+)</Button>
              <Button data-testid="button-add-credit" variant="default" className="flex-1 bg-green-600 hover:bg-green-700" onClick={() => addTransaction(false)}>Tahsilat Ekle (-)</Button>
            </div>
          </div>
